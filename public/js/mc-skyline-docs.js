(function () {
  ...
  const DEFAULT_DOCUMENT = {
    ...
    sections: [
      ...
      { id: 'tax', title: '7. ภาษีและการหัก ณ ที่จ่าย (แนวทางประมาณการ)', paragraphs: [
        'เงินที่เข้าบัญชีของผู้จัดโครงการ หรือเงินที่จ่ายให้ทีม ไม่ควรถูกสรุปว่าไม่ต้องเสียภาษีจากยอดกำไรที่เหลือเพียงอย่างเดียว ต้องจำแนกประเภทเงินได้ ผู้มีหน้าที่เสียภาษี ค่าใช้จ่ายที่หักได้ ค่าลดหย่อน และรายได้อื่นของแต่ละคนก่อน',
        'ถ้าความสัมพันธ์เข้าลักษณะลูกจ้าง เงินเดือน/ค่าจ้างอาจเป็นเงินได้มาตรา 40(1) และผู้จ่ายต้องคำนวณหักภาษี ณ ที่จ่ายตามหลักเกณฑ์ ไม่ใช่หักเปอร์เซ็นต์เดียวทุกคน ส่วนการรับทำงานให้/ฟรีแลนซ์อาจเข้ามาตรา 40(2) และวิธีหักอาจต่างกัน ต้องให้ผู้ทำบัญชีตรวจสัญญาและข้อเท็จจริงก่อนจ่ายจริง',
        'ภาษีหัก ณ ที่จ่ายเป็นเงินที่นำส่งแทนล่วงหน้าและโดยทั่วไปนำไปเป็นเครดิตของผู้รับเงิน ไม่ใช่การรับรองว่าภาษีทั้งปีจบแล้ว การไม่มีเงินเหลือแบ่งกำไรจึงไม่ใช่ข้อสรุปว่าไม่มีหน้าที่ภาษีของผู้มีรายรับ'
      ], table: { headers: ['เงินได้สุทธิทั้งปี', 'อัตราโดยขั้น', 'ภาษีสะสมสูงสุดโดยประมาณ'], rows: [
        ['ไม่เกิน 150,000 บาท', 'ยกเว้น', '0 บาท'], ['150,001–300,000 บาท', '5% เฉพาะส่วนเกิน 150,000', '7,500 บาท'],
        ['300,001–500,000 บาท', '10% เฉพาะส่วนในขั้น', '27,500 บาท'], ['500,001–750,000 บาท', '15% เฉพาะส่วนในขั้น', '65,000 บาท'],
        ['750,001–1,000,000 บาท', '20% เฉพาะส่วนในขั้น', '115,000 บาท'], ['1,000,001–2,000,000 บาท', '25% เฉพาะส่วนในขั้น', '365,000 บาท'],
        ['2,000,001–5,000,000 บาท', '30% เฉพาะส่วนในขั้น', '1,265,000 บาท'], ['เกิน 5,000,000 บาท', '35% เฉพาะส่วนเกิน', 'คำนวณเพิ่มตามขั้น']
      ] }, links: [
        { label: 'กรมสรรพากร: โครงสร้างภาษีและค่าใช้จ่าย', url: 'https://www.rd.go.th/59668.html' },
        { label: 'กรมสรรพากร: ภาษีหัก ณ ที่จ่าย', url: 'https://www.rd.go.th/7064.html' },
        { label: 'แบบ ภ.ง.ด.1 และคำชี้แจง', url: 'https://www.rd.go.th/fileadmin/tax_pdf/withhold/200360_WHT1.pdf' }
      ] },
      { id: 'tax-example', title: '7.1 ตัวอย่างประมาณการที่ใช้ตรวจสอบภายใน', paragraphs: [
        'ตัวอย่าง A: รายรับทั้งปี 300,000 บาท หักค่าใช้จ่ายโครงการที่พิสูจน์ได้ 120,000 บาท เหลือ 180,000 บาท หากสมมติว่าผู้รับมีค่าลดหย่อนส่วนตัว 60,000 บาทและไม่มีรายได้อื่น เงินได้สุทธิแบบง่ายจะอยู่ที่ 120,000 บาท จึงประมาณภาษี 0 บาทตามขั้นอัตรา แต่ไม่ใช่ผลยื่นจริง',
        'ตัวอย่าง B: รายรับทั้งปี 500,000 บาท หักค่าใช้จ่ายโครงการที่พิสูจน์ได้ 200,000 บาท เหลือ 300,000 บาท หักค่าลดหย่อนส่วนตัว 60,000 บาท เหลือ 240,000 บาท ภาษีตามขั้นแบบง่ายประมาณ (240,000 - 150,000) × 5% = 4,500 บาท ก่อนหักภาษี ณ ที่จ่าย/ค่าลดหย่อนอื่น',
        'ทั้งสองตัวอย่างสมมติการจำแนกเงินได้และค่าใช้จ่ายแบบหนึ่งเท่านั้น ไม่ใช่สูตรอัตโนมัติสำหรับโครงการจริง เพราะเงินได้ 40(1)–(8) มีวิธีหักค่าใช้จ่ายต่างกัน และผู้จัดโครงการอาจมีรายได้อื่น'
      ], items: [
        'ทุกเดือนให้ทำบัญชีรายรับแยกตามแหล่ง เงินคืน/ยกเลิก ค่าไฟ VPS โดเมน ซอฟต์แวร์ ค่าธรรมเนียม และหลักฐานค่าใช้จ่าย',
        'ก่อนจ่ายทีมให้แยก “ค่าจ้าง/เงินเดือน” ออกจาก “ส่วนแบ่งกำไร” ในเอกสารและบัญชี ห้ามใช้ชื่อส่วนแบ่งกำไรเพื่อหลีกเลี่ยงหน้าที่หักภาษี',
        'เก็บยอดภาษีที่หักไว้ หนังสือรับรองการหักภาษี และหลักฐานการนำส่งให้ผู้รับแต่ละราย เพื่อใช้ตรวจสอบและเครดิตภาษีปลายปี'
      ] },
      { id: 'split', title: '8. สูตรเงินและสัดส่วนแบ่งกำไร (ร่างเสนอเพื่อเจรจา)', paragraphs: [
        'สูตรกลางที่แนะนำ: รายรับจริง − เงินคืน/ค่าธรรมเนียม − ต้นทุนโครงการที่อนุมัติและมีหลักฐาน − เงินสำรองภาษี/ภาระที่ต้องนำส่ง = กำไรสุทธิที่นำมาแบ่ง หากผลลัพธ์ไม่เป็นบวก จะไม่มีการแบ่งกำไรในรอบนั้น',
        'ตัวอย่างสัดส่วนเมื่อมีกำไรสุทธิที่นำมาแบ่ง 100%: นายพงศ์ภรณ์ ทองศิริ 40%, Developer 10% ต่อคน (รวม 20%), Builder 5% ต่อคน (รวม 10%), System/Item/Quest 5% ต่อคน (รวม 10%), Modeler 3% ต่อคน (รวม 6%), Resource Pack 3% ต่อคน (รวม 6%), และกองกลางทีมงานอื่น 8% ตามผลงาน/การอนุมัติ',
        'สัดส่วนนี้เป็นเพียงข้อเสนอเริ่มต้น ไม่ใช่สิทธิที่เกิดขึ้นแล้ว ต้องระบุผู้มีสิทธิ จำนวนคนจริง เงื่อนไขได้/เสียสิทธิ วันปิดรอบ สูตรปัดเศษ และการเปลี่ยนสัดส่วนในสัญญาที่ทุกฝ่ายยอมรับ'
      ], table: { headers: ['ผู้รับ/กองกลาง', 'สัดส่วนร่าง', 'หมายเหตุ'], rows: [
        ['นายพงศ์ภรณ์ ทองศิริ', '40%', 'ผู้จัดหาเงินทุน/ผู้จัดโครงการ ตามสัญญา'], ['Developer 2 คน', '10% ต่อคน', 'รวม 20%'], ['Builder 2 คน', '5% ต่อคน', 'รวม 10%'],
        ['System / Item / Quest 2 คน', '5% ต่อคน', 'รวม 10%'], ['Modeler 2 คน', '3% ต่อคน', 'รวม 6%'], ['Resource Pack 2 คน', '3% ต่อคน', 'รวม 6%'], ['ทีมงานอื่น', 'กองกลาง 8%', 'แบ่งตามผลงานและหลักเกณฑ์ที่ประกาศ']
      ] }
      },
