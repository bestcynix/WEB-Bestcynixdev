...
- Supabase Dashboard Edge Function `status-api` probes SkylineBOT, Lanyard/Discord, Firebase Hosting, public Firestore CMS access, and the protected Firestore chat endpoint.
